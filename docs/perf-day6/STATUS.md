...
Current fox-fast: **86.56s** (lin **52.4** · sdpa **29.5**) after Q5 + k+=16  
...
- **REJECT** INT8 t128/fc1 `LDS_K=BK+8` (microbench 19.6 vs 19.5).
...
| 09:00 | fox-fast k+=16 | denoise GPU **86.56** (lin **52.4** · sdpa 29.5) |
