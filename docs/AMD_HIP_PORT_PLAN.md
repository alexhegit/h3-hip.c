...
`./h3_hip_bf16_tests` runs 71 CPU-oracle checks without MLX fixtures. Phase 5
...
with compile-time K=5376/14336, `linear_int8_grouped_nax_r128x64` for FC2 when
`hidden_dim % 1024 == 0`) are in place. The 64×64 `sdot4` tiles are the default
