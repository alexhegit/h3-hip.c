...
**Status (local `hip` branch):** Phase 0 complete. Phase 1A/1B largely done (~64/88
...
`sdpa_f32`). `./h3_hip_bf16_tests` runs 53 CPU-oracle checks without MLX fixtures.
Phase 5 int8 and reference NAX paths (`mlp_nax_bf16`,
