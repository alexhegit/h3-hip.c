...
**Status (local `hip` branch):** Phase 0 complete. Phase 1A/1B largely done (~62/88
...
`weight_norm_f32`, `geglu_f32`, `gate_f32`, `adaln_f32`). `./h3_hip_bf16_tests`
runs 51 CPU-oracle checks without MLX fixtures. Phase 5 int8 and reference NAX paths (`mlp_nax_bf16`,
