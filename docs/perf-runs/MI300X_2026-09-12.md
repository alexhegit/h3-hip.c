...
Every numeric cell below is `--profile` **H3 DiT total** from the
2026-09-12 logs (including 15 s), not `/usr/bin/time` to MP4.

2026-09-18 process E2E on tag v0.12.0 (`b0ff702`): fox-s2 **10.6 s**,
fox-fast **9.8 s**, 15 s no-TR **213 s**, `fox-15s.sh` **149 s**,
`fox-15s-fast.sh` **118 s**. See
[`MI300X_2026-09-18_full.md`](MI300X_2026-09-18_full.md).
