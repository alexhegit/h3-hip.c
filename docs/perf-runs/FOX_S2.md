...
**Current tagged baseline:** [`V0.9.0.md`](V0.9.0.md).

---

## Run v0.9.0 — 2026-08-26

Two timed fox-s2 repeats, md5 `1731f95c…`, E2E **87.30 s** then **82.88 s**.
Phase tables, fox-fast, and vs-B: [`V0.9.0.md`](V0.9.0.md).
