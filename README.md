...
- **SageAttention experiment** (MI300X REJECT — opt-in code on `sageattn` branch only): [`docs/sageAttn.md`](docs/sageAttn.md) · [`docs/SAGEATTN_MI300X_RESULTS.md`](docs/SAGEATTN_MI300X_RESULTS.md)
